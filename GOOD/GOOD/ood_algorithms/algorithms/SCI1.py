...
class SCI1(BaseOODAlg):
    ...
    def set_up(self, model: torch.nn.Module, config: Union[CommonArgs, Munch]):
        ...
        params_list =[
            ...
            {'params': self.model.z5.parameters(), 'lr': config.train.lr},
        ...
        self.optimizer = torch.optim.Adam(params_list, lr=config.train.lr, weight_decay=config.train.weight_decay)
