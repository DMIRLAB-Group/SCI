...
class SCI3(BaseOODAlg):
    ...
    def set_up(self, model: torch.nn.Module, config: Union[CommonArgs, Munch]):
        ...
        self.optimizer = torch.optim.Adam([
            ...
            {'params': self.model.mu_linear.parameters(), 'lr': config.train.decoder_lr},
            {'params': self.model.logvar_linear.parameters(), 'lr': config.train.decoder_lr},
            ...
            # {'params': self.model.z5_MLP.parameters(), 'lr': config.train.lr},
