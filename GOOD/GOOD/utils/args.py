...
class OODArgs(Tap):
    ...
    """
    y_loss_para: float = None
    A_loss_para: float = None
    gh_A_loss_para: float = None
    g1_loss_para: float = None
    k1_loss_para: float = None
    x1_loss_para: float = None
    gh_sparity_para: float = None
    KL_para: float = None
    Lr_para: float = None
    gh_sparity_loss_para: float = None
    gn_sparity_loss_para: float= None
