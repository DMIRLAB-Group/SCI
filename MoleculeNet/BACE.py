...
def train(model, dataset, optimizer, loss_function):
    ...
    for counter, train_batch in enumerate(batch_list):
        ...
        losstotal = Loss_function(adj, atoms_adj, g_A, gh, gn, z2, z2_A, x1, k1, x_atom, node_y, mu, logvar, gh_sparity, gn_sparity, gh_kl, gn_kl, args.KL_para, args.gn_sparity_loss_para, args.gh_sparity_loss_para, args.g1_loss_para, args.x1_loss_para, args.k1_loss_para, args.Lr_para, args.batch_size, args.device)
        for i, task in enumerate(tasks):
